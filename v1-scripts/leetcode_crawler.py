...
class LeetCodeCrawler:
    ...
    def crawl(
        self, url: str, include_solutions: bool = True, include_my_submission: bool = True
    ) -> Dict:
        """Main crawl method"""
        ...
        if self.authenticated:
            ...
            print(
                "Warning: Authentication required to fetch solutions/submissions. Provide session cookies."
            )
...
How to get your session cookies:
  ...
  4. Copy the values of 'LEETCODE_SESSION' and 'csrftoken'
    ...
    parser.add_argument(
        "--no-my-submission", action="store_true", help="Skip fetching your last submission"
    )
    parser.add_argument(
        "--save-json",
        action="store_true",
    ...
    crawler = LeetCodeCrawler(session_cookie=args.session, csrf_token=args.csrf)

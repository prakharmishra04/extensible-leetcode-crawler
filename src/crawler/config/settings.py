...
class Config:
    ...
    def from_env(cls, base_config: Optional["Config"] = None) -> "Config":
        ...
        config_dict = {
            ...
            "leetcode_graphql_url": os.getenv(
                "CRAWLER_LEETCODE_GRAPHQL_URL",
                base_config.leetcode_graphql_url
            ),
            "leetcode_session_token": os.getenv(
                "CRAWLER_LEETCODE_SESSION_TOKEN",
                base_config.leetcode_session_token
            ),
            "leetcode_username": os.getenv(
                "CRAWLER_LEETCODE_USERNAME",
                base_config.leetcode_username
            ),
            
            # Future platforms
            "hackerrank_api_key": os.getenv(
                "CRAWLER_HACKERRANK_API_KEY",
                base_config.hackerrank_api_key
            ),
            "codechef_username": os.getenv(
                "CRAWLER_CODECHEF_USERNAME",
                base_config.codechef_username
            ),
            "codechef_password": os.getenv(
                "CRAWLER_CODECHEF_PASSWORD",
                base_config.codechef_password
            ),
            "codeforces_api_key": os.getenv(
                "CRAWLER_CODEFORCES_API_KEY",
                base_config.codeforces_api_key
            ),
            "codeforces_api_secret": os.getenv(
                "CRAWLER_CODEFORCES_API_SECRET",
                base_config.codeforces_api_secret
            ),
            
            # Rate limiting
            "requests_per_second": float(os.getenv(
                "CRAWLER_REQUESTS_PER_SECOND",
                str(base_config.requests_per_second)
            )),
            
            # Retry configuration
            "max_retries": int(os.getenv(
                "CRAWLER_MAX_RETRIES",
                str(base_config.max_retries)
            )),
            "initial_delay": float(os.getenv(
                "CRAWLER_INITIAL_DELAY",
                str(base_config.initial_delay)
            )),
            "max_delay": float(os.getenv(
                "CRAWLER_MAX_DELAY",
                str(base_config.max_delay)
            )),
            "exponential_base": float(os.getenv(
                "CRAWLER_EXPONENTIAL_BASE",
                str(base_config.exponential_base)
            )),
            "jitter": os.getenv(
                "CRAWLER_JITTER",
                str(base_config.jitter)
            ).lower() in ("true", "1", "yes"),
            ...
            "default_format": os.getenv(
                "CRAWLER_DEFAULT_FORMAT",
                base_config.default_format
            ),
    ...
    def from_file(cls, file_path: Path, base_config: Optional["Config"] = None) -> "Config":
        ...
        config_dict = {
            ...
            "requests_per_second": file_config.get(
                "requests_per_second",
                base_config.requests_per_second
            ),
            
            # Retry configuration
            "max_retries": file_config.get(
                "max_retries",
                base_config.max_retries
            ),
            "initial_delay": file_config.get(
                "initial_delay",
                base_config.initial_delay
            ),
            "max_delay": file_config.get(
                "max_delay",
                base_config.max_delay
            ),
            "exponential_base": file_config.get(
                "exponential_base",
                base_config.exponential_base
            ),
            "jitter": file_config.get(
                "jitter",
                base_config.jitter
            ),
            
            # Output configuration
            "output_dir": file_config.get(
                "output_dir",
                base_config.output_dir
            ),
            "default_format": file_config.get(
                "default_format",
                base_config.default_format
            ),
            
            # Logging configuration
            "log_level": file_config.get(
                "log_level",
                base_config.log_level
            ),
            "log_file": file_config.get(
                "log_file",
                base_config.log_file
            ),
        }
    ...
    @classmethod
    def from_cli_args(cls, args: Dict[str, Any], base_config: Optional["Config"] = None) -> "Config":
        ...
        config_dict = {
            ...
            "leetcode_username": args.get(
                "leetcode_username",
                base_config.leetcode_username
            ),
            
            # Future platforms
            "hackerrank_api_key": args.get(
                "hackerrank_api_key",
                base_config.hackerrank_api_key
            ),
            "codechef_username": args.get(
                "codechef_username",
                base_config.codechef_username
            ),
            "codechef_password": args.get(
                "codechef_password",
                base_config.codechef_password
            ),
            "codeforces_api_key": args.get(
                "codeforces_api_key",
                base_config.codeforces_api_key
            ),
            ...
            # Rate limiting
            "requests_per_second": args.get(
                "requests_per_second",
                base_config.requests_per_second
            ),
            
            # Retry configuration
            "max_retries": args.get(
                "max_retries",
                base_config.max_retries
            ),
            "initial_delay": args.get(
                "initial_delay",
                base_config.initial_delay
            ),
            "max_delay": args.get(

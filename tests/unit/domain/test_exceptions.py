...
class TestNetworkException:
    ...
    def test_network_exception_with_url(self):
        ...
        exc = NetworkException("Connection failed", url="https://api.example.com/problems")
        assert str(exc) == "Connection failed"
    ...
    def test_network_exception_with_status_code(self):
        ...
        exc = NetworkException("Server error", status_code=500)
    ...
    def test_network_exception_with_all_parameters(self):
        ...
        exc = NetworkException(
            "Request failed", url="https://api.example.com/problems", status_code=429
        )
...
class TestCommandExecutionException:
    ...
    def test_command_execution_exception_with_original_exception(self):
        ...
        exc = CommandExecutionException("batch", "validation failed", original_exception=original)
    ...
    def test_command_execution_exception_stores_attributes(self):
        ...
        exc = CommandExecutionException("list", "runtime error", original_exception=original)
...
class TestExceptionUsagePatterns:
    ...
    def test_exception_chaining(self):
        ...
        try:
            ...
            exc = CommandExecutionException("download", "validation failed", original_exception=e)
            assert exc.original_exception is original

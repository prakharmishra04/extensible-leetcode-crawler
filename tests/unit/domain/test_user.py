...
class TestUser:
    ...
    def test_user_with_zero_solved(self):
        ...
        user = User(username="newbie", platform="leetcode", solved_count=0, problems_solved=[])
    ...
    def test_empty_username_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Username cannot be empty"):
            User(username="", platform="leetcode", solved_count=0, problems_solved=[])
    ...
    def test_empty_platform_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Platform cannot be empty"):
            User(username="john_doe", platform="", solved_count=0, problems_solved=[])
    ...
    def test_negative_solved_count_raises_error(self):
        ...
        with pytest.raises(ValueError, match="Solved count must be non-negative"):
            User(username="john_doe", platform="leetcode", solved_count=-1, problems_solved=[])

    def test_mismatched_count_and_list_raises_error(self):
        """Test that mismatched count and list length raises ValueError"""
        with pytest.raises(
            ValueError, match="Problems solved list length .* must match solved count"
        ):
            User(
                username="john_doe",
                platform="leetcode",

...
def sample_problem():
    ...
    return Problem(
        ...
        constraints=[Constraint("2 <= nums.length <= 10^4")],
        examples=[
            Example(
...
class TestFileSystemRepository:
    ...
    def test_find_by_id_returns_problem_when_exists(self, temp_repo, sample_problem):
    ...
    def test_find_by_id_reconstructs_all_fields(self, temp_repo, sample_problem):
    ...
    def test_exists_returns_true_for_saved_problem(self, temp_repo, sample_problem):
    ...
    def test_delete_removes_problem_directory(self, temp_repo, sample_problem, tmp_path):
    ...
    def test_find_by_id_raises_exception_on_invalid_json(self, temp_repo, sample_problem, tmp_path):
    ...
    def test_serialize_problem_includes_all_fields(self, temp_repo, sample_problem):
        ...
        assert data["constraints"] == [{"text": "2 <= nums.length <= 10^4"}]
        assert len(data["examples"]) == 1
        assert data["hints"] == ["Use a hash map"]
        assert data["acceptance_rate"] == 49.1

    def test_serialize_problem_with_submission(self, temp_repo, sample_problem, sample_submission):
    ...
    def test_deserialize_problem_reconstructs_correctly(self, temp_repo, sample_problem):

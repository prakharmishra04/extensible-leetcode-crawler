...
class TestListCommandSuccess:
    ...
    def test_execute_success_no_filters(
    ...
    def test_execute_success_with_sorting(
        self, mock_repository, mock_logger, sample_problems
    ):
    ...
    def test_execute_success_empty_result(
...
class TestListCommandErrors:
    ...
    def test_execute_repository_exception(
        self, mock_repository, mock_logger
    ):
    ...
    def test_execute_invalid_sort_field(
        self, mock_repository, mock_logger
    ):
    ...
    def test_execute_invalid_difficulty(
        self, mock_repository, mock_logger
    ):
    ...
    def test_execute_empty_platform_string(
        self, mock_repository, mock_logger
    ):
